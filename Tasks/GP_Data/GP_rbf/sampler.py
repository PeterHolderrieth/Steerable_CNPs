...
def Create_GP_Data_File_2d(filename,n_samples,min_x,max_x,n_grid_points,l_scale=1,sigma_var=1, 
                        kernel_type="rbf",obs_noise=1e-2):
    #Sample data:
    ...
    np.save('Tasks/GP_Data/GP_rbf/Data/'+filename+'_X', X_data.numpy())
    np.save('Tasks/GP_Data/GP_rbf/Data/'+filename+'_Y', Y_data.numpy())
...
TRAIN_FILENAME='GP_rbf_Train'
VAL_FILENAME='GP_rbf_Valid'
TEST_FILENAME='GP_rbf_Test'
