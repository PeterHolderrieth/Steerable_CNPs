...
def Create_GP_Data_File_2d(filename,n_samples=10,min_x=-2,max_x=2,n_grid_points=10,l_scale=1,sigma_var=1, 
    ...
    np.save('Tasks/GP_div_free_small/Data/'+filename+'_X', X_data.numpy())
    np.save('Tasks/GP_div_free_small/Data/'+filename+'_Y', Y_data.numpy())
...
TRAIN_FILENAME='GP_Small_Train'
VAL_FILENAME='GP_Small_Valid'
TEST_FILENAME='GP_Small_Test'
